 ...
 */
export async function notifyAdminOnSelection({ adminEmail, adminPhone, sendEmail: doEmail, sendSMS: doSMS, userName, userEmail, selectedDishes, shoppingListHtml }) {
...
export function generateShoppingListHtml(byCategory) {
  ...
  const categoryOrder = ['viande', 'poisson', 'legume', 'feculent', 'produit_laitier', 'oeuf', 'epice', 'condiment', 'fruit', 'fruits_a_coque', 'autre']
    ...
    if (byCategory.has(cat)) {
      ...
      html += `
        <div style="margin-bottom: 15px;">
          <h4 style="color: #ea580c; margin-bottom: 8px; font-size: 14px;">${categoryLabels[cat] || cat}</h4>
