...
export async function loadDishOverrides(userId) {
  ...
  const result = await sql`
    SELECT dish_id, action, custom_name, remove_ingredients, substitute_ingredients, add_ingredients
...
export async function loadDishOverridesForUsers(userIds) {
  ...
  const result = await sql`
    SELECT user_id, dish_id, action, custom_name, remove_ingredients, substitute_ingredients, add_ingredients
    FROM user_dish_overrides
